...
Gem::Specification.new do |spec|
  ...
  spec.description = "Data structures include Ractor::LockFree::Var and Ractor::LockFree::Hash"
  spec.license = "MIT"
  # spec.homepage = "https://github.com/<you>/ractor-lockfree"
  # spec.metadata["source_code_uri"] = spec.homepage
  spec.required_ruby_version = ">= 4.0"
  spec.extensions = %w[ext/ractor/lockfree_var/extconf.rb ext/ractor/lockfree_hash/extconf.rb]
